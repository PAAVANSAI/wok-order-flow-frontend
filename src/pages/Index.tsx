        ...
        <div className="max-w-4xl mx-auto">
          <header className="mb-8 text-center">
            <h1 className="text-4xl font-bold text-chickey-dark mb-3">
              Welcome to <span className="text-chickey-primary">Chickey Woks</span>
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Link to="/orders" className="block h-full transition-transform hover:scale-105">
              <Card className="h-full flex flex-col shadow-lg border-chickey-primary border-t-4">
                <CardHeader>
            ...
            <Link to="/inventory" className="block h-full transition-transform hover:scale-105">
              <Card className="h-full flex flex-col shadow-lg border-chickey-secondary border-t-4">
                <CardHeader>
